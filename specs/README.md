...
This directory contains all architectural documentation for the biocontext platform. It is the primary entry point for understanding how the system is designed and why.
...
| [reference-home-assistant-architecture.md](reference-home-assistant-architecture.md) | Research reference documenting Home Assistant's architecture in detail. Used to inform biocontext design decisions — HA is the closest architectural analog. Not a spec for this project. |
...
The documentation structure is informed by [arc42](https://arc42.org/), a widely-adopted software architecture documentation template. The table below maps arc42 sections to their biocontext equivalents for readers familiar with that framework. We use descriptive file names rather than arc42's numbered sections — the navigation benefit comes from the completeness checklist, not the naming convention.

| arc42 Section | biocontext Document |
|---|---|
